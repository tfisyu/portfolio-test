...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('talkingtaki1@outlook.com');
...
/*       style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(93,108,111,1) 35%, rgba(93,108,111,1) 100%)'
      }} */
      style={{
